# 🛡️ Guardian Shield Proxy

> NGINX reverse proxy leveraging custom Lua scripts to scan prompt payloads at the gateway layer.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/guardian-shield/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-guardian-shield.git
cd tp-guardian-shield
```
...
```bash
kubectl port-forward deployment/tp-guardian-shield 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── nginx_shield.conf     # Main configuration file
```
...
---
*Generated by [Guardian Shield Proxy Studio](https://pradeeptalari14.github.io/portfolio/tools/guardian-shield/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
